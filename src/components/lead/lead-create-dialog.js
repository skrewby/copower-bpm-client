...
export const LeadCreateDialog = (props) => {
  ...
  const getData = useCallback(async () => {
    try {
      ...
      const creator_id = await firebase.auth().currentUser.getIdTokenResult()
        .then((idTokenResult) => {
          const creator_email = idTokenResult.claims.email;
          const creator_obj = usersAPI.filter(user => user.email === creator_email)
    ...
    >
      ...
      <DialogContent>
        ...
        >
          ...
          >
            <InputField
              error={Boolean(formik.touched.company_abn && formik.errors.company_abn)}
              fullWidth
              helperText={formik.touched.company_abn && formik.errors.company_abn}
              label="Company ABN"
              name="company_abn"
              onBlur={formik.handleBlur}
              onChange={formik.handleChange}
          ...
          >
            <InputField
              error={Boolean(formik.touched.sales_id && formik.errors.sales_id)}
              fullWidth
              helperText={formik.touched.sales_id && formik.errors.sales_id}
              label="Assign Sales"
              name="sales_id"
              onBlur={formik.handleBlur}
              onChange={formik.handleChange}
