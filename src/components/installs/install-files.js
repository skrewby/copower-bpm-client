...
import { LeadAddFileDialog } from '../lead/lead-add-file-dialog';
import toast from 'react-hot-toast';

export const InstallFiles = (props) => {
  const { files: filesProp, ...other } = props;
  const [fileDialogOpen, handleOpenFileDialog, handleCloseFileDialog] = useDialog();
