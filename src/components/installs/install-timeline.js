...
const getItems = (status) => {
  const statusMapping = ['new', 'deposit', 'ptc', 'schedule', 'review', 'payment', 'retailer', 'stc', 'complete'];
...
InstallTimeline.propTypes = {
  status: PropTypes.oneOf(['new', 'deposit', 'ptc', 'schedule', 'review', 'payment', 'retailer', 'stc', 'complete']).isRequired
};
